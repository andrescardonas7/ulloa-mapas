...
description: >-
  Instinct-based learning (ECC v2.1) for Cursor — YAML in .cursor/hooks/state/instincts/.
  Load when capturing session patterns into reusable behaviors. Cursor only; Alfred uses
  workspace/memory/ instead.
origin: ECC (MIT)
version: 2.1.0-hub
---
...
| Feature | v2.0 | v2.1 |
|---------|------|------|
| Storage | Global (`~/.claude/homunculus/`) | **This hub:** `.cursor/hooks/state/instincts/` (see `ecc-harness-performance`) |
