...
This skill provides tools for reviewing fix branches against security audit reports. It analyzes commit ranges to:
...
In this hub: `.cursor/skills/fix-review/`. Entry point: `SKILL.md`. Command: `/fix-review`.
