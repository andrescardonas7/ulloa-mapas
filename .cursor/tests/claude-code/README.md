...
- **Platform:** Bash on Linux/macOS, or WSL/Git Bash on Windows (scripts use Unix tools: `mktemp`, `timeout`, etc.)
...
- **LLM output fragility:** Some assertions depend on Claude's wording (e.g. "once" vs "one time"). If tests flake, consider broadening regex patterns.
