...
- Do not provide instructions to jailbreak, bypass safety filters, or misuse third-party AI services
- Red-team model guidance is for authorized safety evaluations only
- Cite sources for security claims; distinguish research speculation from verified results
- Refuse help that enables non-consensual surveillance, deception, or automated abuse at scale
